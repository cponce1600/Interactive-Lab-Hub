...
while(True):
    ...
    cv2.namedWindow('detected (press q to quit)', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('detected (press q to quit)', window_width, window_height)
